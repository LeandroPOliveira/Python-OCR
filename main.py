...
if platform.system() == "Windows":
    ...
    pytesseract.pytesseract.tesseract_cmd = (
        r"C:\Users\loliveira\AppData\Local\Tesseract-OCR\tesseract.exe"
    )

    # Windows also needs poppler_exe
    path_to_poppler_exe = Path(r"C:\Users\loliveira\Downloads\Release-22.04.0-0\poppler-22.04.0\Library\bin")

    # Put our output files in a sane place...
    out_directory = Path(r"C:\Users\loliveira\PycharmProjects\OCR").expanduser()
else:
    out_directory = Path("~").expanduser()

# Path of the Input pdf
PDF_file = Path(r"enge.pdf")
